...
import { GiRazor, GiBeautyMask } from "react-icons/gi";

const Services = () => {
  const services = [
    {
      name: "HAIRDRESSING",
      description: <>Discover the Legendary <span className="text-[#C8A448]">JEENO FADE</span>, cover greys or refresh your color, or opt for a classic trim—perfect for men and children of all ages.</>,
      icon: Scissors
    },
    {
